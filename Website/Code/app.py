...
# A function initiating a thread. The target is the init_socket from above. The thread is started and joined. A print with the message "New thread started" is shown.      
def init_thread():
